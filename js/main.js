	...
	$('#term').terminal(function(command,term) {
		if(command == 'test') {
			...
			term.echo("\
				...
				I am passionate about <span style='color: #d6c3b6'>programming, economic research and rowing</span> and \n\
				I have a fledging career as a <span style='color: #d6c3b6'>go (igo)</span> player.</td>\
				</tr></table>\
				To get more information, type <span style='color: #d6c3b6'>links</span>\
				<br><br>\
				", {raw: true});
